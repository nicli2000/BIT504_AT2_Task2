...
public class Board {
	...
	public boolean isDraw() {
		...
		// Check whether any of the cells content in the board grid are Player.Empty. If
		// they are, it is not a draw.
		// Return false if it is not a draw, return true if there are no empty positions
		// left
		for (int row = 0; row < GameMain.ROWS; ++row) {
			for (int col = 0; col < GameMain.COLS; ++col) {
